// $Id: AcmeQuadFaceQ8.C,v 2002.1 2004/06/18 17:47:04 mwglass Exp $
...
AcmeQuadFaceQ8::AcmeQuadFaceQ8( int Block_Index, 
				int Index_in_Block, 
                                int Exo_ID ) 
  : AcmeFace( AcmeEntity::QUADFACEQ8, 
...
AcmeQuadFaceQ8::~AcmeQuadFaceQ8() {}

void AcmeQuadFaceQ8::Evaluate_Shape_Functions( Real* local_coords,
						  Real* shape_functions )
{
  Compute_Shape_Functions( local_coords, shape_functions );
}

void AcmeQuadFaceQ8::Compute_Global_Coordinates( Real* local_coords,
						 Real* global_coords )
{
...
void AcmeQuadFaceQ8::Compute_Local_Coordinates( Real* global_coords,
						Real* local_coords )
{
  int  i, j;
  Real node_positions[8][3];
...
void AcmeQuadFaceQ8::Compute_Shape_Functions( Real local_coords[2],
...
void AcmeQuadFaceQ8::Compute_Shape_Derivatives( Real local_coords[2],
...
void AcmeQuadFaceQ8::Compute_Local_Coords( Real node_positions[8][3],
...
void AcmeQuadFaceQ8::Compute_Global_Coords( Real node_positions[8][3],
					       Real local_coords[2],
					       Real global_coords[3] )
{
  Real N[8];
...
void AcmeQuadFaceQ8::Interpolate_Scalar( Real  local_coords[2],
					    Real  node_scalars[8],
...
void AcmeQuadFaceQ8::Interpolate_Vector( Real local_coords[2],
