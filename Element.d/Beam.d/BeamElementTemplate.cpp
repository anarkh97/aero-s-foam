...
/* .....CHECK IF MATERIAL PROPERTIES ARE POSITIVE OR ZERO */
    ...
    if (E <= zero || A < zero || nu < zero || Ix < zero || Iy < zero || Iz < zero || alphay < zero || alphaz < zero || C1 < zero) {
...
/* .....INITIALIZE THE ENTRIES OF THE LOCAL STIFFNESS MATRIX */
    ...
    s11 = zero;  s17 = zero;
    s22 = zero;  s26 = zero;  s28 = zero;  s212 = zero;
    s33 = zero;  s35 = zero;  s39 = zero;  s311 = zero; 
    s44 = zero;  s410 = zero; 
    s55 = zero;  s59 = zero;  s511 = zero;
    s66 = zero;  s68 = zero;  s612 = zero;
    s77 = zero;
    s88 = zero;  s812 = zero;
    s99 = zero;  s911 = zero;
    s1010 = zero;
...
/* .....WRITE THE VON MISES RESULTANT INTO THE STRESS ARRAY */
    ...
    stress(6,0) = sqrt( 0.5*(stress_0dxy*stress_0dxy + stress_0dyz*stress_0dyz + stress_0dxz*stress_0dxz) +
                          3*(stress(3,0)*stress(3,0) + stress(4,0)*stress(4,0) + stress(5,0)*stress(5,0)) ) + 1.0e-10;
    stress(6,1) = sqrt( 0.5*(stress_1dxy*stress_1dxy + stress_1dyz*stress_1dyz + stress_1dxz*stress_1dxz) +
                          3*(stress(3,1)*stress(3,1) + stress(4,1)*stress(4,1) + stress(5,1)*stress(5,1)) ) + 1.0e-10;
