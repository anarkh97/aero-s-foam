...
class TimoshenkoBeamStressWRTDisplacementSensitivity : public VectorValuedFunction<12,2,Scalar,26,1,double>
{
  public:
  ...
  public:
    TimoshenkoBeamStressWRTDisplacementSensitivity(const Eigen::Array<double,26,1>& sconst, const Eigen::Array<int,1,1>& iconst)
    {
