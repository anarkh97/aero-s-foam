...
! 9.  real(8) function   distpt                           (opt,ndime, points)
! 10. real(8) function   distele                          (opt,ndime,nnode,ecord1,ecord2)
! 11. subroutine         elecntr                          (ndime,nnode,ecord, cntrpt)
! 12. subroutine         divdln                           (optdvd,ndime,rm,rn,points, ptdivd)
! 13. real(8) function   distpt2ele                       (opt,ndime,nnode,pt,ecord)
! 14. subroutine         getsubtri2d0                     (mtri,npt,ptcord, ntri,triconc,triarea) ! construct sub tri.
!
! =========================================================================================================
...
subroutine elecntr(ndime,nnode,ecord, cntrpt)
  !=======================================================================
  ...
  !  output:
  !  ------
  !  cntrpt(ndime,1) : center point of element
  !
  ! ======================================================================
  ...
  real(8), dimension(ndime,1), intent(out) :: cntrpt
  ! ====================================
  ! local variable
  ! ==============
  ...
  do inode=1, nnode
     do idime=1, ndime
        cntrpt(idime,1)= cntrpt(idime,1) + ecord(idime,inode)/ real(nnode)
     end do
  end do
