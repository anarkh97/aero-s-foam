...
subroutine elemaslbt2(nndof,ematpro,ecord,edisp, emaslbt)
  !=======================================================================
  !  elemaslbt = compute argumented rotation lumped mass matrix
  !              for 5 or 6 dof bt shell element
  !
  !              note:
  !              ---
  !              [1] hughes, cohen and haroun, NED, 1978, vol. 46, pp. 203-222
  !              reduced and selective integration techniques in
  !              the finite element analysis of plates
  !              (see, ch 4.1)
  !
  !              [2] kennedy, belytschko and lin, NED, 1986, vol. 97, pp. 1-24
  !              recent developments in explicit finite element techniques and
  !              their application to reactor structures
  !              (see, eq (16))
  !
  ...
  !  output:
  !  ------
  !  emaslbt(nndof*4,nndof*4) : lumped element mass matrix
  !
  ! ======================================================================
  ...
  real(8), dimension(nndof*4,nndof*4), intent(out) :: emaslbt
  ! ====================================
  ! local variable
  ! ==============
  real(8) :: denst, thick
  ...
  ! compute scaling factor alpha
  ! from ref [2] "the second form is more representative of the rotatory inertia of a cross section,
  !               but sometimes results in smaller stable time steps."
  alpha= area / 8.0d0 ! (thick**2 + area)/12.0d0
