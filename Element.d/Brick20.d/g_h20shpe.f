C
      subroutine  gxh20shpe(xi,eta,mu,x,y,z,dx,dy,dz,sf,sx,sy,
     *                    sz,dsx,dsy,dsz,det,ddet)
C
C                   A R G U M E N T S
C
C      implicit none
      double precision  xi, eta, mu, x(20), y(20), z(20)
      double precision  dx(20), dy(20), dz(20)
      double precision  sf(20), sx(20), sy(20), sz(20), det
      double precision  dsf(20), dsx(20), dsy(20), dsz(20), ddet
C
...
C
      ...
      double precision   dxd1,dxd2,dxd3,dyd1,dyd2,dyd3,dzd1,dzd2,dzd3
      double precision   a11, a12, a13, a21, a22, a23, a31, a32, a33
      double precision   da11,da12,da13,da21,da22,da23,da31,da32,da33
      double precision   cdet,dcdet
...
C--------------------------------------- DERIVATIVE EVALUATION
      ...
      do 1500   i = 1,20
         ...
         dxd1  =  dxd1 +  dx(i) * sd1(i)
         dxd2  =  dxd2 +  dx(i) * sd2(i)
         dxd3  =  dxd3 +  dx(i) * sd3(i)
         dyd1  =  dyd1 +  dy(i) * sd1(i)
         dyd2  =  dyd2 +  dy(i) * sd2(i)
         dyd3  =  dyd3 +  dy(i) * sd3(i)
         dzd1  =  dzd1 +  dz(i) * sd1(i)
         dzd2  =  dzd2 +  dz(i) * sd2(i)
         dzd3  =  dzd3 +  dz(i) * sd3(i)
 1500  continue
       a11 = yd2*zd3 - yd3*zd2
       a12 = yd3*zd1 - yd1*zd3
       a13 = yd1*zd2 - yd2*zd1
       ...
       do 2000  i = 1,20
          ...
          dsx(i) =dcdet *( a11 * sd1(i) + a12 * sd2(i) + a13 * sd3(i))
          dsy(i) =dcdet *( a21 * sd1(i) + a22 * sd2(i) + a23 * sd3(i))
          dsz(i) =dcdet *( a31 * sd1(i) + a32 * sd2(i) + a33 * sd3(i))
          dsx(i) =dsx(i)+cdet*(da11*sd1(i)+ da12*sd2(i) + da13*sd3(i))
          dsy(i) =dsy(i)+cdet*(da21*sd1(i)+ da22*sd2(i) + da23*sd3(i))
          dsz(i) =dsz(i)+cdet*(da31*sd1(i)+ da32*sd2(i) + da33*sd3(i))
