...
C=====================================================================C
      subroutine g_compcrd2(g_p_, elm, type, x, g_x, ldg_x, y, g_y, ldg_
     *y, z, g_z, ldg_z, rot, g_rot, ldg_rot, xlp, g_xlp, ldg_xlp, ylp, g
     *_ylp, ldg_ylp, zlp, rowb, colb, rowm, colm, xp, g_xp, ldg_xp, yp, 
     *g_yp, ldg_yp, zp, g_zp, ldg_zp)
C=====================================================================C
C                                                                     C
...
C
        integer g_pmax_
        parameter (g_pmax_ = 1)
        integer g_i_, g_p_, ldg_xlp, ldg_ylp, ldg_rot, ldg_x, ldg_y, ldg
     *_z, ldg_xp, ldg_zp
        integer ldg_yp
        double precision d2_w, d2_b, d3_b, d1_w, d1_p, d5_b, d4_b, d2_v,
     * d3_v, g_xlp(ldg_xlp, 3)
        double precision g_ylp(ldg_ylp, 3), g_rot(ldg_rot, 6, 6), g_x21(
     *g_pmax_), g_x(ldg_x, 3), g_y21(g_pmax_), g_y(ldg_y, 3), g_z21(g_pm
     *ax_), g_z(ldg_z, 3), g_x32(g_pmax_), g_y32(g_pmax_)
        double precision g_z32(g_pmax_), g_d2_w(g_pmax_), g_d1_w(g_pmax_
     *), g_side21length(g_pmax_), g_xp(ldg_xp, 3), g_zp(ldg_zp, 3), g_le
     *ngthz(g_pmax_), g_yp(ldg_yp, 3), g_lengthy(g_pmax_), g_xcg(g_pmax_
     *)
        double precision g_ycg(g_pmax_), g_zcg(g_pmax_), g_xlcg(g_pmax_)
     *, g_ylcg(g_pmax_), g_zlcg(g_pmax_)
        save g_lengthy, g_xcg, g_ycg, g_zcg, g_xlcg, g_ylcg, g_zlcg
        save g_x21, g_y21, g_z21, g_x32, g_y32, g_z32, g_d2_w, g_d1_w, g
     *_side21length, g_lengthz
        external g_compfrot
...
C
        ...
        v3n(3) = one
C
        call g_compfrot(g_p_, xp, g_xp, ldg_xp, yp, g_yp, ldg_yp, zp, g_
     *zp, ldg_zp, v1n, v2n, v3n, rot, g_rot, ldg_rot)
C
