#ifdef USE_EIGEN3
#ifndef _SHELLELEMENTHICKNESSSENSITIVITY_H_
#define _SHELLELEMENTHICKNESSSENSITIVITY_H_
...
class ShellElementThicknessSensitivity : public VectorValuedFunction<1,3,Scalar,30,1,double>
{
  public:
  ...
  public:
    ShellElementThicknessSensitivity(const Eigen::Array<double,30,1>& sconst, const Eigen::Array<int,1,1>& iconst)
    {
...
inline void ComputeShellElementThicknessSensitivity()
{
