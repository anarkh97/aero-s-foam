...
FullSquareMatrix
SloshTetra::stiffness(CoordSet &cs, double *d, int flg)
{
...
void
SloshTetra::computeMetrics(CoordSet& cs)
{
...
void
SloshTetra::buildTetraStiff(double TetraStiff[4][4])
{
	int i,j,k;
	double dot;
...
void
SloshTetra::buildTetraMass(double tetraMass[4][4])
{
