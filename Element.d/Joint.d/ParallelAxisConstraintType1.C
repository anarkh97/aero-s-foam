...
ParallelAxisConstraintType1::ParallelAxisConstraintType1(int* _nn)
{
  nSubElems = 2, nnodes = 2; int nDofsPerNode = 3;
  subElems = new Element * [nSubElems];
  subElems[0] = new DotConstraintType1(_nn, 1, 0);
  subElems[1] = new DotConstraintType1(_nn, 2, 0);
...
int 
ParallelAxisConstraintType1::getTopNumber() 
{ 
  return 106; 
}
