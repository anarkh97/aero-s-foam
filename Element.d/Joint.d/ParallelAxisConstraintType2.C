...
ParallelAxisConstraintType2::ParallelAxisConstraintType2(int* _nn)
{
  nSubElems = 2, nnodes = 2; int nDofsPerNode = 6;
  subElems = new Element * [nSubElems];
  subElems[0] = new DotConstraintType2(_nn, 1);
  subElems[1] = new DotConstraintType2(_nn, 2);
...
int 
ParallelAxisConstraintType2::getTopNumber() 
{ 
  return 106; 
}
