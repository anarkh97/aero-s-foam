...
class LineVariLineDistanceConstraintFunction : public RheonomicConstraintFunction<12,Scalar,17,1,double>
{
...
/*template<> template<>
int
ConstraintJacobian<double,LineVariLineDistanceConstraintFunction>
::operator() (const Eigen::Matrix<double,3,1>& q, Eigen::Matrix<double,3,1>& J) const;

template<> template<>
int
SacadoReverseJacobian<ConstraintJacobian<double,LineVariLineDistanceConstraintFunction> >
