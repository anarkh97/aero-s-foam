...
class SegmentSegmentDistanceConstraintFunction : public RheonomicConstraintFunction<6,Scalar,17,1,double>
{
...
/*template<> template<>
int
ConstraintJacobian<double,SegmentSegmentDistanceConstraintFunction>
::operator() (const Eigen::Matrix<double,3,1>& q, Eigen::Matrix<double,3,1>& J) const;

template<> template<>
int
SacadoReverseJacobian<ConstraintJacobian<double,SegmentSegmentDistanceConstraintFunction> >
