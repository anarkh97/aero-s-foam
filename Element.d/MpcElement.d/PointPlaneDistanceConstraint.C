...
PointPlaneDistanceConstraint::PointPlaneDistanceConstraint(int* _nn)
 : ConstraintFunctionElement<PointPlaneDistanceConstraintFunction>(1, DofSet::XYZdisp, _nn, 0)
{
}

void
PointPlaneDistanceConstraint::setFrame(EFrame *elemframe)
{
  for(int i = 0; i < 3; ++i) {
    x1[i] = (*elemframe)[0][i];
    x2[i] = (*elemframe)[1][i];
...
void
PointPlaneDistanceConstraint::getConstants(CoordSet& cs, Eigen::Array<double,17,1>& sconst, Eigen::Array<int,1,1>& iconst)
{
