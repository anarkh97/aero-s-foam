...
PointVariLineDistanceConstraint::PointVariLineDistanceConstraint(int* _nn)
 : ConstraintFunctionElement<PointVariLineDistanceConstraintFunction>(3, DofSet::XYZdisp, _nn, 0)
{
}

void
PointVariLineDistanceConstraint::getConstants(CoordSet& cs, Eigen::Array<double,14,1>& sconst, Eigen::Array<int,1,1>& iconst)
{
