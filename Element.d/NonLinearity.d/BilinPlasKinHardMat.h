...
class BilinPlasKinHardMat : public Material {
   ...
   public:
     ...
     BilinPlasKinHardMat(double _rho, double _E, double _nu,double _Ep, double _sigE ){rho=_rho; E=_E; nu=_nu; Ep=_Ep; sigE=_sigE;}
