...
C
      subroutine g_rotation(g_p_, v1o, g_v1o, ldg_v1o, v2o, g_v2o, ldg_v
     *2o, v3o, g_v3o, ldg_v3o, v1n, v2n, v3n, r, g_r, ldg_r)
C
C Declarations
C
...
C
        integer g_pmax_
        parameter (g_pmax_ = 1)
        integer g_i_, g_p_, ldg_r, ldg_v1o, ldg_v2o, ldg_v3o
        double precision g_r(ldg_r, 3, 3), g_v1o(ldg_v1o, 3), g_v2o(ldg_
     *v2o, 3), g_v3o(ldg_v3o, 3)
        integer g_ehfid
        data g_ehfid /0/
C
...
C
        do i = 1, 3
          do g_i_ = 1, g_p_
            g_r(g_i_, 1, 1) = v1n(i) * g_v1o(g_i_, i) + g_r(g_i_, 1, 1)
          enddo
          r(1, 1) = r(1, 1) + v1n(i) * v1o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 1, 2) = v1n(i) * g_v2o(g_i_, i) + g_r(g_i_, 1, 2)
          enddo
          r(1, 2) = r(1, 2) + v1n(i) * v2o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 1, 3) = v1n(i) * g_v3o(g_i_, i) + g_r(g_i_, 1, 3)
          enddo
          r(1, 3) = r(1, 3) + v1n(i) * v3o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 2, 1) = v2n(i) * g_v1o(g_i_, i) + g_r(g_i_, 2, 1)
          enddo
          r(2, 1) = r(2, 1) + v2n(i) * v1o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 2, 2) = v2n(i) * g_v2o(g_i_, i) + g_r(g_i_, 2, 2)
          enddo
          r(2, 2) = r(2, 2) + v2n(i) * v2o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 2, 3) = v2n(i) * g_v3o(g_i_, i) + g_r(g_i_, 2, 3)
          enddo
          r(2, 3) = r(2, 3) + v2n(i) * v3o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 3, 1) = v3n(i) * g_v1o(g_i_, i) + g_r(g_i_, 3, 1)
          enddo
          r(3, 1) = r(3, 1) + v3n(i) * v1o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 3, 2) = v3n(i) * g_v2o(g_i_, i) + g_r(g_i_, 3, 2)
          enddo
          r(3, 2) = r(3, 2) + v3n(i) * v2o(i)
C--------
          do g_i_ = 1, g_p_
            g_r(g_i_, 3, 3) = v3n(i) * g_v3o(g_i_, i) + g_r(g_i_, 3, 3)
          enddo
