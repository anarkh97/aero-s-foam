...
%token FREQSWEEP FREQSWEEP1 FREQSWEEP2 FSINTERFACE FSISCALING FSIELEMENT NOLOCALFSISPLITING FSICORNER FFIDEBUG FAILSAFE FOLLOWER
...
*/
        ...
        | NLInfo FOLLOWER NewLine
        { domain->solInfo().followerMoment = true; }
        | NLInfo NewtonInfo
        ;
NewtonInfo:
