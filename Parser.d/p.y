...
%token FABMAT FACOUSTICS FETI FETI2TYPE FETIPREC FFP FFPDIR FITALG FNAME FLUX FORCE FRONTAL FETIH FILTEREIG FLUID
...
%token RADIATION RAYDAMP RBMFILTER RBMSET READMODE REBUILD RENUM RENUMBERID REORTHO RESTART RECONS RECONSALG REBUILDCCT RANDOM RPROP RNORM REVERSENORMALS ROTVECOUTTYPE RESCALING RELATIVEWEIGHTLIST
...
WeightList :
       ...
       | WeightList Integer Float NewLine
        ...
        ;
RelativeWeightList :
       RELATIVEWEIGHTLIST NewLine
        {}
       | RelativeWeightList ACOU Integer NewLine
        { relativeWeightList[(int)Element::Acoustic] = $3; }
       | RelativeWeightList MECH Integer NewLine
        { relativeWeightList[(int)Element::Structural] = $3; }
       | RelativeWeightList HEAT Integer NewLine
        { relativeWeightList[(int)Element::Thermal] = $3; }
       | RelativeWeightList FLUID Integer NewLine
        { relativeWeightList[(int)Element::Fluid] = $3; }
MFTTInfo:
	MFTT NewLine
