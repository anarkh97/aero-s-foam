C     Gradient of stiffness matrix of 8-node hexahedron in 3-D  stress
C

C
      subroutine gxbrik8v(x, dx, y, dy, z, dz, c, dc, p, sm, status)
C
C                   A R G U M E N T S
C
      integer p,status
      real*8  x(8),   y(8),  z(8),  c(6,6)
      real*8  dx(8), dy(8), dz(8), dc(6,6)
      real*8  sm(24,24)
C
C                   L O C A L   V A R I A B L E S
C
      real*8  q(8),  qx(8),  qy(8), qz(8)
      real*8  ddet, dqx(8), dqy(8),dqz(8), dw, cvar
      real*8  xi, eta, emu, det, w, weight
      real*8  c1x, c1y, c1z, c2x, c2y, c2z, c3x, c3y, c3z
      real*8  c4x, c4y, c4z, c5x, c5y, c5z, c6x, c6y, c6z
      real*8  dc1x, dc1y, dc1z, dc2x, dc2y, dc2z, dc3x, dc3y, dc3z
      real*8  dc4x, dc4y, dc4z, dc5x, dc5y, dc5z, dc6x, dc6y, dc6z
