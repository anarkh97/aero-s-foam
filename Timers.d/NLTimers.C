...
*/
 ...
 if (f != 0)  {
 fprintf(f,"\n***********************************************************\n");
 fprintf(f," ... Non-linear Problem Information ... \n");
 fprintf(f,"***********************************************************\n\n");
 ...
 fprintf(f,"1. Total Read Input Files              time: %14.5f %14.3f Mb\n", 
         totalRead/1000.0, totalMemRead*byteToMb);
 fprintf(f,"         Read Mesh                     time: %14.5f\n",
 ...
 fprintf(f,  "         Process Input Data            time: %14.5f\n",
         times.setUpDataTime/1000.0);
 fprintf(f,  "         Make Subdomains               time: %14.5f\n",  
         times.makeSubDomains/1000.0);
 fprintf(f,  "         Distribute BCs                time: %14.5f\n",  
         times.distributeBCs/1000.0);
 fprintf(f,  "         Make Connectivities           time: %14.5f\n",  
         times.makeConnectivity/1000.0);
 fprintf(f,  "         Make Interface                time: %14.5f\n",  
 ...
 fprintf(f,"4. Total Subdomain RHS Processing      time: %14.5f %14.3f Mb\n\n",
         formRhsMax/1000.0, timers.memoryLoad *byteToMb);
 }  // end if
...
*/
 ...
 fprintf(f,"\nTOTAL SIMULATION (1+2+3+4+5+6)         time: %14.5f %14.3f Mb\n",
